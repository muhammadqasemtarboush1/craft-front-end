...
export default function Header(){
    return (
        <header className='flex justify-between items-center bg-amber-900 p-1 px-3 w-screen'>
            ...
            <img className="shadow-md bg-slate-50 rounded-full p-3" src="https://thumbs.dreamstime.com/z/illustration-drawing-art-hand-tools-logo-white-background-hand-tools-logo-182124077.jpg" alt="img" width="5% " height="5%" />
