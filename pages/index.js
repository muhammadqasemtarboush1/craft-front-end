        ...
        <div className='grid grid-cols-2 grid-flow-row gap-28 px-44 text-center'>
          {
            Products.map(item => {
              return (
                <div key={item.id} className="max-w-lg p-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:duration-300 flex flex-col justify-center items-center bg-gray-100">
